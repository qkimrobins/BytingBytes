...
import { ListChecks, Target, Users, IndianRupee, CircleDollarSign } from 'lucide-react';
...
const spendAnalysisData = [
    { name: 'Resources', value: 110000 },
    { name: 'Vendors', value: 65000 },
...
export default function DashboardPage() {
  ...
  const SPEND_COLORS = ['hsl(var(--chart-1))', 'hsl(var(--chart-2))', 'hsl(var(--chart-3))', 'hsl(var(--chart-4))', 'hsl(var(--chart-5))'];
      ...
      <div className="grid gap-4">
          <Card>
              <CardHeader>
                  ...
                  <CardDescription>
                      Breakdown of where your funds are being allocated.
                  </CardDescription>
              </CardHeader>
              <CardContent>
                  <ResponsiveContainer width="100%" height={300}>
                      <PieChart>
                          <Pie
                              ...
                              dataKey="value"
                          >
                              {spendAnalysisData.map((entry, index) => (
                                  <Cell key={`cell-${index}`} fill={SPEND_COLORS[index % SPEND_COLORS.length]} />
                              ))}
                          </Pie>
                          <Tooltip
